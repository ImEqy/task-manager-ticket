...
var wpeo_point_ticket = {
  event: function() {
	jQuery( document ).on( 'click', '.wpeo-done-point', function( e ) {
 wpeo_point_ticket.switch_completed( jQuery( this ) );
 } );
    jQuery( document ).on( 'click', '.wpeo-submit', function() {
 wpeo_point_ticket.create_point_time( jQuery( this ) );
 } );
  },
